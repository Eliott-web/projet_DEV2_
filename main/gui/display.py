...
from gui.widget.image import ImageWidget

widget_manager = WidgetManager()

# Exemple: créer un logo au centre
logo = ImageWidget("assets/logo.png", pos=(WIDTH//2, 200), size=(300,150), anchor="center",
                   on_click=lambda w: print("Logo cliqué !"))
widget_manager.add(logo)
